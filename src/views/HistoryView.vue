...
<template>
  ...
  >
    ...
    <div class="flex flex-col md:w-1/2 w-full gap-4">
      <div class="collapse collapse-plus pb-5">
        <input type="radio" name="my-accordion-3" />
        <div
          className="collapse-title text-xl font-medium bg-success rounded-b-2xl mb-4 "
        >
          Vous avez {{ likes.length }} likes
        </div>
        <div className="collapse-content flex flex-col w-full gap-4">
      ...
      <div className="collapse collapse-plus pb-5">
        <input type="radio" name="my-accordion-3" defaultChecked />
        <div
          className="collapse-title text-xl font-medium bg-error rounded-b-2xl mb-4"
        >
